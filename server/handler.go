...
func make_checkin_handler(db *sql.DB) http.HandlerFunc {
        return func(w http.ResponseWriter, r *http.Request) {
                ...
                if err := insert_checkin(db, payload.Hostname, payload.LoggedUser, payload.CheckedInAt, payload.CpuPercent); err != nil {
                ...
                fmt.Printf("[check-in] host=%s user=%s cpu=%.1f%% time=%s\n",
                        payload.Hostname,
                        payload.LoggedUser,
                        payload.CpuPercent,
